...
def test2(x1,x2,y1,y2):
    G_drive = ox.graph_from_point((x1,x2), dist=7500, network_type="drive_service") # ดาวน์โหลดเครือข่ายถนนในรัศมีที่ใหญ่ขึ้นเพื่อให้ครอบคลุมทั้งจุดเริ่มต้นและปลายทาง
